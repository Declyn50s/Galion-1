...
import type { Tache, Utilisateur } from "./types";
...
export const statutBadgeClass = (s: Tache["statut"]) => {
...
export const priorityDot = (p: Tache["priorite"]) =>
  p === "Haute" ? "bg-red-600" : "";

export const tagBadgeClass = (tag: string) => {
